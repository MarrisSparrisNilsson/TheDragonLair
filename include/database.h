...
#define MAX_FILENAME 99 // The meximum number of characters that the file name can consist of.
#define NAME_SIZE 10 // The meximum number of characters a name can consist of.
